    ...
    where Self: Sized
{
    ...
    #[cfg(any(feature = "debug_renderer", feature="capture"))]
    fn attach_read_texture(&mut self, texture: &Texture, layer_id: i32);
    ...
    fn create_vbo<T>(&mut self) -> Self::VBO;

    fn delete_vbo<T>(&mut self, vbo: Self::VBO);
    ...
    fn update_vao_indices<I>(&mut self, vao: &Self::VAO, indices: &[I], usage_hint: VertexUsageHint);
