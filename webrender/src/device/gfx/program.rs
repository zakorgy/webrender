...
impl<B: hal::Backend> Program<B> {
    ...
    pub(super) fn submit(
        ...
        let group: super::descriptor::DescriptorGroup = self.shader_kind.into();
        println!("Submitting program {:?}", (&self.shader_name, self.shader_kind, group));
        ...
        unsafe {
            ...
            cmd_buffer.bind_graphics_descriptor_sets(
                pipeline_layout,
                super::descriptor::DESCRIPTOR_SET_PER_TARGET,
                iter::once(desc_set_per_target)
