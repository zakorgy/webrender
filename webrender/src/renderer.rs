...
//        //let gpu_profile = GpuProfiler::new(Rc::clone(device.rc_gl()));
    ...
    pub fn get_graphics_api_info(&self) -> GraphicsApiInfo {
        GraphicsApiInfo {
            ...
            version: "TODO: version".into(), //self.device.gl().get_string(gl::VERSION),
            renderer: "TODO: renderer".into(), //self.device.gl().get_string(gl::RENDERER),
        }
    }
...
//            self.device.end_frame();
    ...
    fn flush(&mut self) {
        self.device.ps_line.instance_buffer.offset = 0;
        self.device.ps_line.instance_buffer.size = 1;
    }
