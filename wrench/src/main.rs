...
fn main() {
    ...
    'outer: loop {
        ...
        match window {
            WindowWrapper::Headless(..) => {
                events.push(winit::Event::Awakened);
            }
        ...
        for event in events {
            match event {
                ...
                winit::Event::WindowEvent{ window_id: _, event: winit::WindowEvent::Refresh } |
                winit::Event::WindowEvent{ window_id: _, event: winit::WindowEvent::Focused(..) } |
                winit::Event::WindowEvent{ window_id: _, event: winit::WindowEvent::CursorMoved {..} } => {
                    do_render = true;
                }
